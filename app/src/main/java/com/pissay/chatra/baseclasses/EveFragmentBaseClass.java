 ...
 */
public abstract class EveFragmentBaseClass extends Fragment implements View.OnClickListener, ServerCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{

    protected EveBaseActivity m_cObjMainActivity;
    ...
    public void onAttach(Activity pObjActivity) {
        ...
        m_cObjMainActivity = (EveBaseActivity) getActivity();
