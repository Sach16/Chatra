 ...
 */
public class CustomRecyclerAdapterForListOfHalls extends RecyclerView.Adapter {
    ...
    public CustomRecyclerAdapterForListOfHalls(Context pContext, List<Evnts> pJsonLeads, RecyclerHallsListener pListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            lView = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_card_cell, parent, false);
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Nullable
        @BindView(R.id.CROWD_TXT)
        TextView crowdtxt;

        @Nullable
        @BindView(R.id.PARKING_NO_TXT)
        TextView parkingNoTxt;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof DataObjectHolder) {
            ...
            try {
                ((DataObjectHolder) holder).crowdtxt.setText(m_cObjJsonLeads.get(position).getCrowd().toString());
            } catch (Exception e) {
                e.printStackTrace();
            }

            try {
                ((DataObjectHolder) holder).parkingNoTxt.setText(m_cObjJsonLeads.get(position).getParking().toString());
            } catch (Exception e) {
                e.printStackTrace();
            }
